...
export default function page() {
  ...
  return (
    <div className=" bg-DarkGrey min-h-[600px] max-w-[1000px] w-full rounded-xl shadow-lg p-7  max-600:p-3 ">
      <div className="w-full max-w-[1000px] flex justify-between p-3 relative">
        <div>
          <h1 className="text-2xl font-bold mb-4 max-400:text-xl max-350:text-lg">
            გამოხმაურებები
          </h1>
        </div>
        <button
      ...
      {isAddModalOpen && (
        <div className="max-w-[600px] w-full  absolute left-1/2 translate-x-[-20%] max-1100:translate-x-[-40%] max-800:translate-x-[-50%] max-700:max-w-[400px] max-450:max-w-[300px]">
          <FeedbackPopup
